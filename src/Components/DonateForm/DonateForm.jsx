    ...
    <section id ="donate-form">
      <form className="mt-10 flex flex-col items-center justify-center" method="POST">
          ...
          <div className="p-5 flex gap-5">
            ...
            <select className = {`border-2 ${isMoney ? `w-[31vw]` : ` w-48 `}`} id="category" name="category" defaultValue="money" ref={moneyRef} onChange={handleCategoryChange}>
            ...
            <input className={` ${isMoney && `hidden`} border-2 w-44`} type="text" name="item" id="item-name" placeholder=" Whats your donation?" required />
          </div>
          ...
          <div className="p-5 flex gap-5">
            ...
            <textarea className=  {`${isMoney && `hidden`} border-2 w-64`} name="pickup-details" id="pickup-details" placeholder=" PickUp Details" rows="1" required />
          </div>
